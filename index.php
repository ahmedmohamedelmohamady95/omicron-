...
<html lang="en">
   ...
   <!-- Site Metas -->
   <title>Virus Omicron - Responsive HTML5 Multi Page Template</title>
               ...
               <div class="right-header">
                  <div class="header-info">
                     <div class="info-inner">
                        ...
                        <span class="iconcont"><a href="tel:01001780859">01001780859</a></span>	
                     </div>
                     <div class="info-inner">
                        <span class="icontop"><i class="fa fa-envelope" aria-hidden="true"></i></span>
                        <span class="iconcont"><a data-scroll href="mailto:info@yoursite.com">info@ SOmicron.com</a></span>	
                     </div>
...
<!--                         <li><a data-scroll href="#service">Services</a></li>
 -->                        <li><a data-scroll href="#doctors">Doctors</a></li>
                        <li><a data-scroll href="Hospital-omicron/public_html/login.php">Diagnosis</a></li>
						<li><a data-scroll href="omicron-tms">omicron virus analysis</a></li>
               ...
               <div class="col-md-12 col-sm-12">
                  <div class="text-contant">
                     <h2>
                        ...
                        <a href="" class="typewrite" data-period="2000" data-type='[ "Best Wishes For a Speedy Recovery", "We Care Your Health", "We are Expert!" ]'>
               ...
               <div class="row">
                  <div class="service-time middle" style="background:#0071d1;">
                     ...
                     <div class="time-table-section">
                        <ul>
                           <li><span class="left"> Friday - Thursday</span><span class="right">24.00</span></li>
                           <li><span class="left">Friday</span><span class="right">24.00</span></li>
                           <li><span class="left">Saturday</span><span class="right">24.00</span></li>
                           <li><span class="left">Sunday</span><span class="right">24.00</span></li>
                           <li><span class="left">Monday</span><span class="right">24.00</span></li>
                           <li><span class="left">Tuesday</span><span class="right">24.00</span></li>
                           <li><span class="left">Wednesdayday</span><span class="right">24.00</span></li>
                           <li><span class="left">Thursday</span><span class="right">24.00</span></li>
                        </ul>
                     </div>
                  </div>
               </div>
            ...
            <div class="row">
               <div class="col-md-6">
                  <div class="message-box">
                     ...
                     <p class="lead">أهم الخدمات التي يقدمها قسم خدمات المرضى استقبال شكاوى المرضى والمراجعين والتواصل مع الأقسام المعنية لإيجاد حلول لها، والتواصل مع أجنحة التنويم لحل القضايا المتعلقة بالمرضى. أيضا، الإشراف والمراقبة على الاجراءات الادارية الخاصة بنقل المرضى المحولين إلى المستشفيات المرجعية، والاشراف على خدمات سيارات الاسعاف، وتوجيه وإرشاد الزوار بأماكن تواجد مرضاهم.</p>
